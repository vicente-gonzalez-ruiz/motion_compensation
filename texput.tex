...
\item
  ...
  \imgw{150}{graphics/frame_interpolation_step_3A.svg}
  \imgw{200}{graphics/frame_interpolation_step_3A_bis.svg}
\item
  While \(l>0\):
  ...
  \item
    ...
    \imgw{150}{graphics/frame_interpolation_step_4A.svg}
    \imgw{200}{graphics/frame_interpolation_step_4A_bis.svg}

  \item
    \(LL^{l-1}(M)\leftarrow LL^{l-1}(M)\times 2\).
    \imgw{200}{graphics/frame_interpolation_step_4B.svg}
  
  \item
    Refine \(LL^{l-1}(m)\) using \(\pm 1\)-spiral-search.
    \imgw{200}{graphics/frame_interpolation_step_4C.svg"}
  ...
  \imgw{200}{graphics/motion_vectors.svg}
...
\item
  ...
  \item
    ...
    \imgw{200}{graphics/frame_interpolation_step_5B.svg}
    
  \item
    \(m\leftarrow m\times 2\).
    
    \imgw{210}{graphics/motion_vectors_by_2.svg}
  ...
  \item
    ...
    \imgw{280}{graphics/motion_vectors_definitive.svg}
...
\img{graphics/quality-scalability.svg}
\begin{itemize}
\item
...
\img{graphics/temporal-scalability.svg}
\begin{itemize}
\item
  It holds that
...
\img{graphics/spatial-scalability.svg}
\begin{itemize}
\item
