...
\item
  ...
  \img{graphics/frame_interpolation_step_2.svg}
...
\item
  ...
  \imgw{1000}{graphics/frame_interpolation_step_3A.svg}
  \img{graphics/frame_interpolation_step_3A_bis.svg}
\item
  While $l>0$:
  ...
  \item
    ...
    \imgw{1000}{graphics/frame_interpolation_step_4A.svg}
    \img{graphics/frame_interpolation_step_4A_bis.svg}

  \item
    $LL^{l-1}(M)\leftarrow LL^{l-1}(M)\times 2$.
    \img{graphics/frame_interpolation_step_4B.svg}
  
  \item
    Refine $LL^{l-1}(m)$ using $\pm 1$-spiral-search.
    \img{graphics/frame_interpolation_step_4C.svg}
  ...
  \img{graphics/motion_vectors.svg}
...
\item
  ...
  \item
    ...
    \imgw{1000}{graphics/frame_interpolation_step_5B.svg}
